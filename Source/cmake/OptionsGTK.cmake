...
WEBKIT_OPTION_DEFINE(ENABLE_QNXSCREEN_TARGET "Whether to enable support for the QNX Screen windowing target." PUBLIC ON)
...
if (ENABLE_QNXSCREEN_TARGET AND NOT ${GTK_SUPPORTS_QNXSCREEN})
    set(ENABLE_WAYLAND_TARGET OFF)
endif ()
...
if (WEBKITGTK_API_VERSION VERSION_EQUAL "4.0")
    CALCULATE_LIBRARY_VERSIONS_FROM_LIBTOOL_TRIPLE(WEBKIT 110 0 73)
    CALCULATE_LIBRARY_VERSIONS_FROM_LIBTOOL_TRIPLE(JAVASCRIPTCORE 46 0 28)
elseif (WEBKITGTK_API_VERSION VERSION_EQUAL "4.1")
    CALCULATE_LIBRARY_VERSIONS_FROM_LIBTOOL_TRIPLE(WEBKIT 18 0 18)
    CALCULATE_LIBRARY_VERSIONS_FROM_LIBTOOL_TRIPLE(JAVASCRIPTCORE 9 0 9)
elseif (WEBKITGTK_API_VERSION VERSION_EQUAL "6.0")
    CALCULATE_LIBRARY_VERSIONS_FROM_LIBTOOL_TRIPLE(WEBKIT 16 0 12)
    CALCULATE_LIBRARY_VERSIONS_FROM_LIBTOOL_TRIPLE(JAVASCRIPTCORE 7 0 6)
else ()
...
SET_AND_EXPOSE_TO_BUILD(WTF_PLATFORM_QNXSCREEN ${ENABLE_QNXSCREEN_TARGET})
...
if (ENABLE_QNXSCREEN_TARGET)
    if (NOT GTK_SUPPORTS_QNXSCREEN)
        message(FATAL_ERROR "Recompile GTK with QNX Screen backend to use ENABLE_QNXSCREEN_TARGET")
    endif ()

    find_library(SCREEN_LIB NAMES screen REQUIRED)
endif ()
